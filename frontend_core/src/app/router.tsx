...
import { PlanningDetailPage } from '@/pages/anuncios/PlanningDetailPage';
...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'anuncios/planejamentos/:uuid',
        element: withPermission('anuncios.visualizar', <PlanningDetailPage />),
      },
      {
        path: 'contratos',
        element: (
