...
async def list_people(
    ...
    cadastrado_por_lideranca_id: int | None = Query(default=None, ge=1),
    origem_cadastro: str | None = Query(default=None, max_length=30),
    ...
    filters = PessoaFiltros(
        ...
        cadastrado_por_lideranca_id=cadastrado_por_lideranca_id,
